        ...
        <div className='flex flex-col gap-16'>
          <div className='grid gap-4 sm:grid-cols-2'>
            <Card>
              ...
              <CardFooter>
                <Progress value={(100 * (lastWeekSum._sum.amount ?? 0)) / WEEKLY_GOAL}></Progress>
              </CardFooter>
            </Card>
            <Card>
              <CardHeader className='pb-2'>
              ...
              <CardFooter>
                <Progress value={(100 * (lastMonthSum._sum.amount ?? 0)) / MONTHLY_GOAL}></Progress>
              </CardFooter>
            </Card>
          </div>
            ...
            <TableBody>
              {orders.map((order) => (
                <TableRow key={order.id} className='bg-accent'>
                  ...
                  <TableCell className='hidden sm:table-cell'>{order.createdAt.toLocaleDateString()}</TableCell> {/* country base date format */}
