...
const DesignPreview: FC<DesignPreviewProps> = ({ configuration }) => {
  ...
  const { id, color, croppedImageUrl, model, finish, material } = configuration;
    ...
    <>
      ...
      <div className='mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
        <div className=' md:col-span-4 lg:col-span-3 md:row-span-2 md:row-end-2'>
          <Phone className={cn(`bg-${caseTwColor}`, "max-w-[150px] md:max-w-full")} imgSrc={croppedImageUrl!} />
        </div>

        <div className='mt-6 sm:col-span-9 md:row-end-1'>
          <h3 className='text-3xl font-bold tracking-tighter text-gray-900'>Your {modelLabel} Case</h3>
        ...
        <div className='sm:col-span-12 md:col-span-9 text-base'>
          <div className='grid  gird-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
            <div>
              ...
              <ol className='mt-3 text-zinc-700 list-disc list-inside'>
                ...
                <li>Package made from recycled materials</li>
          ...
          <div className='mt-8'>
              ...
              <div className='flow-root text-sm'>
                ...
                {finish === "textured" ? (
                  <div className='flex items-center justify-between py-1 mt-2'>
                    ...
                    <p className='font-medium text-gray-900'>{formatPrice(PRODUCTS_PRICES.finish.textured / 100)}</p>
                  </div>
                ) : null}
                {material === "polycarbonate" ? (
                  <div className='flex items-center justify-between py-1 mt-2'>
                    <p className='text-gray-600'>Soft Polycarbonate material</p>
                    <p className='font-medium text-gray-900'>{formatPrice(PRODUCTS_PRICES.materials.polycarbonate / 100)}</p>
                  </div>
                ) : null}
            ...
            <div className='mt-8 flex justify-end pb-12'>
              <Button isLoading={isPending} disabled={isPending} loadingText='Payment' onClick={handleCheckout} className='px-4 sm:px-6 lg:px-8'>
