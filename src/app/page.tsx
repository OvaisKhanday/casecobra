          ...
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              ...
              <p className='mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap'>
                Capture your favorite memories with your own, <span className='font-semibold'>one-of-one</span> phone case. CaseCobra allows you to
              ...
              <ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-center'>
                <div className='space-y-2'>
                  <li className='flex gap-1 5 items-center text-left'>
                    <Check className='h-5 w-5 shrink-0 text-green-600' /> {/* shrink-0 Never smaller than 5,5*/}
                    High-quality, durable material
                  </li>
                  <li className='flex gap-1 5 items-center text-left'>
                    <Check className='h-5 w-5 shrink-0 text-green-600' /> {/* shrink-0 Never smaller than 5,5*/}5 year print guarantee
                  </li>
                  <li className='flex gap-1 5 items-center text-left'>
                    <Check className='h-5 w-5 shrink-0 text-green-600' /> {/* shrink-0 Never smaller than 5,5*/}
      ...
      <section className='bg-slate-100 py-24'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            <h2 className='order-2 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
              What our{" "}
            ...
            <img src='/snake-2.png' alt='logo' className='w-24 order-1  lg:order-2' />
          </div>
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              <div className='flex gap-0.5 mb-2'>
                <Star className='h-5 w-5 shrink-0 text-green-600 fill-green-600' />
                <Star className='h-5 w-5 shrink-0 text-green-600 fill-green-600' />
                <Star className='h-5 w-5 shrink-0 text-green-600 fill-green-600' />
                <Star className='h-5 w-5 shrink-0 text-green-600 fill-green-600' />
                <Star className='h-5 w-5 shrink-0 text-green-600 fill-green-600' />
              ...
              <div className='text-lg leading-8'>
                <p>
                  &ldquo;The case feels durable and I even got a compliment on the design. Had the case for two and a half months now and{" "}
                  ...
                  into yellow-ish color after a couple of weeks. Love it.&rdquo;
                </p>
              </div>
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  &ldquo;I usually keep my phone together with my keys in my pocket and that let to some pretty heavy scratch-marks on all of my last
                  phone cases. This one, besides a barely noticeable scratch on the corner,{" "}
                  <span className='p-0.5 bg-slate-800 text-white'>looks brand new after about half a year</span>. I dig it.&rdquo;
                </p>
              </div>
              <div className='flex gap-4 mt-2'>
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              ...
              <div className='relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl'>
                <img src='/horse.jpg' alt='' className='rounded-md object-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full' />
              </div>
